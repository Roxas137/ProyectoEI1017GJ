...
public enum MenuOpciones {
    ...
    CAMBIAR_TARIFA("Cambiar la controlador.tarifa de un cliente"),
    VER_CLIENTE("Ver los datos de un cliente"),
    VER_TODOS_CLIENTES("Ver el total de los controlador.clientes"),
    ...
    VER_CLIENTES_FECHAS("Ver los controlador.clientes dados de alta entre dos fechas"),
