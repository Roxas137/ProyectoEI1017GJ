...
public enum MenuOpciones {
    ...
    CAMBIAR_TARIFA("Cambiar la modelo.tarifa de un cliente"),
    VER_CLIENTE("Ver los datos de un cliente"),
    VER_TODOS_CLIENTES("Ver el total de los modelo.clientes"),
    ...
    VER_CLIENTES_FECHAS("Ver los modelo.clientes dados de alta entre dos fechas"),
